    ...
    func updateUIView(_ webView: WKWebView, context: Context) {
        ...
        <div style="background-color:#000000;">
            <div style="background-color:#000000;" class="tradingview-widget-container">
              ...
              <div style="background-color:#000000;" class="tradingview-widget-copyright"><a href="https://ru.tradingview.com/symbols/BTC/?exchange=BINANCE" rel="noopener" target="_blank"><span class="blue-text"></span></a></div>
